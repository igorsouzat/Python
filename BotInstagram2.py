...
class InstagramBot:
    def __init__(self, username, password):
        ...
        self.driver = webdriver.Firefox(
            executable_path=r"C:\Users\igors\Desktop\geckodriver\geckodriver.exe"
    ...
    def curtir_fotos_com_a_hastag(self, hashtag):
        ...
        time.sleep(5)
        for i in range(1, 10):  # Altere o segundo valor aqui para que ele desça a quantidade de páginas que você quiser: quer que ele desça 5 páginas então você deve alterar de range(1,3) para range(1,5)
...
igorBot = InstagramBot(
    "assistenciaportssar", "por32571632"
